...
RACK_WIDTH_CHOICES = (
    ...
    (RACK_WIDTH_OCP_21IN, '21 inches OCP'),
...
CABLE_TYPE_CHOICES = (
    (
        'Copper', (
            ...
            (CABLE_TYPE_DAC_ACTIVE, 'AOC (Active)'),
            (CABLE_TYPE_DAC_PASSIVE, 'DAC (Passive)'),
            (CABLE_TYPE_DAC_PASSIVE_SFP, 'DAC SFP 1G'),
            (CABLE_TYPE_DAC_PASSIVE_SFP_PLUS, 'DAC SFP+ 10G'),
            (CABLE_TYPE_DAC_PASSIVE_SFP28, 'DAC SFP28 25G'),
            (CABLE_TYPE_DAC_PASSIVE_QSFP, 'DAC QSFP+ 40G'),
            (CABLE_TYPE_DAC_PASSIVE_QSFP28, 'DAC QSFP28 100G'),
...
# Single phase loads, (From Phase -> Neutral)
POWERFEED_LEG_A = 1
POWERFEED_LEG_B = 2
POWERFEED_LEG_C = 3
# Phase-Phase Loads
...
POWERFEED_LEG_CHOICES = (
    ...
    (POWERFEED_LEG_B, 'Y'),
    (POWERFEED_LEG_C, 'Z'),
    (POWERFEED_LEG_AB, 'XY L1L2'),
    (POWERFEED_LEG_BC, 'YZ L2L3'),
    (POWERFEED_LEG_CA, 'XZ L3L1'),
)
